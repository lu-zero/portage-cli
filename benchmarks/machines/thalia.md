...
See also `benchmarks/machines/README.md`, `BENCHMARKS.md`, and the scripts' own header comments + `benchmarks/results/portage-repo-regen-vs-pkgcraft-2026-03-04.md` (the old portage-repo/docs/benchmarks.md, moved out of the way of the root docs/design/benchmarks.md map — it's a frozen 2026-03-04 data point, not a living doc).
