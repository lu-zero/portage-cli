...
**Update 2026-09-16 — concrete implementation plans drafted.** The
"measured, not worth it" call below stands on *demand*, but a follow-up
survey of the real binaries (`portageq`, `qgrep`) found most of the surface
