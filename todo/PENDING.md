...
| **0** | **md5-cache blind spot** — an ebuild with no cache entry is *invisible* to em, reported as "no ebuilds"; 44-63 tree-wide today, incl. the world member `sys-fs/btrfs-progs-7.1`. Portage sources the ebuild instead. Subsumes the docutils/sphinx "resolver gap" entirely. Highest value/effort item open | 🔴 found 2026-07-26 | [[md5-cache-blind-spot]] |
