...
| **9** | **`--local` bootstrap** — setup ladder: **repo** (piggy-back or own) + **profile** (defaults/override) + **package.provided** seed, then toolchain --setup. Design 2026-08-07 | 🟡 | [[local-bootstrap-provided]], [`docs/local-bootstrap.md`](../docs/local-bootstrap.md) |
